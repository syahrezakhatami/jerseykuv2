					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +62 895 3071 2651</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> tokojerseyku@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo base_url();?>"><img src="<?php echo base_url()?>assets/front/images/home/logo4.png" alt="" /></a>
						</div>
...
<?php } ?>
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Dapatkan diskon dari toko football lovers untuk jersey terbaru dari club favorit anda!!!</p>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="address">
							<img src="<?php echo base_url()?>assets/front/images/home/map.png" alt="" />
							<p>Cijantung, Jakarta Timur Indonesia 13770</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#">Gelang Aksesoris</a></li>
								<li><a href="#">Bandana</a></li>
								<li><a href="#">Icon Club Doll Merchandise</a></li>
								<li><a href="#">Ball</a></li>
							</ul>
						</div>
					</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 Football Lovers Inc. All rights reserved.</p>
					<p class="pull-right">Develope by <span><a target="_blank" href="http://www.Footballlovers.com">Football Lovers</a></span></p>
				</div>
			</div>
		</div>
